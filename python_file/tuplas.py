...
tupla = ('Geek University', "Progamação em Python: Essencial")
...
tupla1 = tupla1 + tupla2 # Tuplas são imutáveis, mas podemos sobrescrever seua valores
print(tupla3)
...
# O acesso a elementos de uma tupla também é semelhate a de uma lista
...
# Verificamos em qual índice um elemeto está na tupla
...
# - Tuplas são mais do que listas.
# - Tuplas deixam seu código mais seguro*.

# * Isso porque trabalhar com elementos imutáveis traz segurança para código.
...
nova = tupla # Na tupla não temons o problema de Shallow Copy
