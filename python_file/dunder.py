...
Em Python, são utilizados dunder para criar funções, atributos, propriedades e
...
internamente o Python atribui á variável __name__ o valor __main__ indicando
que este módulo é o módulo de execução principal.

# Exemplo 1
from geek.geek1 import soma_impares
