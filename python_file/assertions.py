...
Se expressão for verdadeira, retorna None e caso seja falsa levanta um erro do
tipo AssertionError.
...
def comer_fast_food(comida):
    assert comida in ['pizza', 'sorvete', 'doces', 'batata frita',
                      'cachorro quente'], "A comida precisa ser de fast food"
...
def faca_algo_ruim(usuaio):
    assert usuaio.eh_admin, "Somente administradores podem fazer coisa ruins"
