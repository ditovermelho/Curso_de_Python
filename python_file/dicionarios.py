...
# Tuplas por exemplo são bastante interessantes de serem utilizadas como chave de dicionários, poís as mesmas
# são imutáveís
localidades = {
...
# CONCLUSÂO 2: Em dicionáríos não podemos ter chaves repetidas. 
...
produto1 = {'nome': 'Paystation 4', 'quantidade': 1, 'preco': 2300.00}
...
# Ele vai gerar para cada valor do interável uma chave e ira atribuir a esta chave o valor informado.
